...
export default function AnimatedShaderBackground() {
  ...
  useEffect(() => {
    ...
    // Skip on mobile — WebGL shader is too heavy for phones
    ...
    const material = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          // Semi-transparent overlay — bright enough to stand out, dark enough to keep text readable
          gl_FragColor = vec4(o.rgb * 1.1, o.a * 0.75);
        }
      `,
    });
